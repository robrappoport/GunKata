...
public class CreateSphere : CreatePrimitive
{
    ...
    {
        var obj = PrimitivesPro.GameObjects.Sphere.Create(1, 20, 0, 0, 0, NormalsType.Vertex, PivotPosition.Center);
        obj.SaveStateAll();
...
//        uiChange |= Utils.SliderEdit("Slice", 0, 360, ref obj.slice);
        uiChange |= Utils.SliderEdit("Inner radius", 0, 1, ref obj.innerRadius);
        ...
        Utils.ShowButtons<PrimitivesPro.GameObjects.Sphere>(this);
